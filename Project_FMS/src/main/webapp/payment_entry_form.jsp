...
<html>
    ...
    <body class="container-fluid">
        ...
        <form action="search" method="post" class="form card" id="frm">
            <h2 class="card-header text-white">Update Student Details</h2>
                <table class="table table-hover">
                    
                    <tr>
                        <td>Reg No</td>
                        <td><input type="text" name="reg_no4" required placeholder="Enter Reg No" ></td>
                    </tr>
                        <td>Year</td>
                        <td>
