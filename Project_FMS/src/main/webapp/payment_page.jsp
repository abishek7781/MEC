...
<html>
    ...
    <body>
        ...
        <div class="form">
        <form action="search1" method="post" onsubmit="validate()">
            ...
            <table class="table table-hover">      
                ...
                <tr>
                    <td class="l">Tution Fees </td>
                    <td class="l">${Total_fees}</td>
                </tr>
                
                <tr>
                    <td class="l">Tution fees Pending </td>
                        <td style='color:black;'>${Pending_fees}</td>

                </tr>
                <tr>
                    <td class="l">Tution fees Paid </td>
	...
	<input type="hidden" value=${Reg_no} name="reg_no4" ><br><br>
                ...
                <div>
                    ...
                    <label>Enter Amount: </label>
                     <input type="number" id="amount" name="amount" placeholder="Enter Amount" required class="input-box"
                            min="1000"
                            max="99999"
